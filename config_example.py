...
Вы можете дать право изменять название розыгрыша кому-либо, ответив на сообщение того пользователя \
командой /admgroup add
... и отобрать у него это право, ответив командой /admgroup del
